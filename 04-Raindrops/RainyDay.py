...
def main():
    ...
    mike = Hero(screen,200,400,pygame.image.load("Mike_umbrella.png"),pygame.image.load("Mike.png"))
    # TODO 15: Make a Hero, named alyssa, with appropriate images, starting at position x=700 y=400.
    alyssa = Hero(screen,700,400,pygame.image.load("Alyssa_umbrella.png"),pygame.image.load("Alyssa.png"))
